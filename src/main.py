...
from gestorAplicacion import TipoProducto
...
sup1.agregar_empleado(emp1)
sup1.agregar_bodega(bod1)
sup1.agregar_bodega(bod2)
...
prod5 = Producto("jabón Dove", TipoProducto.CUIDADO_PERSONAL, 18900, 13450)
prod6 = Producto("cuido Dog Chow", TipoProducto.MASCOTA, 125000, 98000)
prod7 = Producto("spray Raid", TipoProducto.OTRO, 17000, 15100)
prod8 = Producto("cepillo Pro 425", TipoProducto.CUIDADO_PERSONAL, 4700, 3000)
