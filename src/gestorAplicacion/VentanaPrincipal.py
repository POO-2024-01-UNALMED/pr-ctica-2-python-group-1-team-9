...
class VentanaPrincipal():
    ...
    def crearMenu(self): # Función para crear el menú
        ...
        menuInicio.add_command(label="Descripción del sistema", command=lambda: self.labelP4.config(image="", font=("Arial"), wraplength=420,
                                text="'Programa Super Usable Para Supermercados'\nle permite administar su inventario, generar ordenenes de compra, hacer registro de clientes, además de llevar un seguimiento de los procesos llevados a cabo en la operación del supermercado. "))
